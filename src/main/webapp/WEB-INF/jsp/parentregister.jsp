...
<%--				<a href="javascript:;"><i class="layui-icon layui-icon-login-weibo"></i></a>--%>
				...
				<a class="layadmin-user-jump-change layadmin-link layui-hide-xs" href=<%=path + "/parentLogin/parentLoginPage.action"%>>用已有帐号登入</a>
<%--				<a href=<%=path + "/parentLogin/parentLoginPage.action"%> class="layadmin-user-jump-change layadmin-link layui-hide-sm layui-show-xs-inline-block">登入</a>--%>
			</div>
		</div>
	</div>
