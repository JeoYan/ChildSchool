...
<div class="container" style="width: 82%;margin:0 auto">
	...
	<div style="margin-top: 30px;">
		...
		<div class="layui-form">
			...
			<a href="/ChildSchool/BackAction/parentWeekCourseTable.action?now-Date=${requestScope.tableHead[0]}&doWhich=上一周&bid=${requestScope.bid}">
				<input type="button" class="btn btn-default layui-btn" value="上一周" onclick="weeks(this)"/>
			</a>

			<a href="/ChildSchool/BackAction/parentWeekCourseTable.action?now-Date=${requestScope.tableHead[0]}&&doWhich=下一周&bid=${requestScope.bid}">
