...
<div class="rigcon">
	<div class="newsdeldiv">
		<div class="newsdel_tit">${requestScope.news.ntitle}</div>
		<div class="explain">发布时间：${requestScope.news.ndate}&nbsp;&nbsp;来源：${requestScope.news.wName}&nbsp;&nbsp</div>
		<div class="newsdel_content">  ${requestScope.news.nconntext}</div>
	</div>
</div>
