...
<div class="layui-form" lay-filter="layui-btn-normal" id="layui-btn-normal" style="padding: 20px 0 0 0;">
	<div class="layui-form-item" style="text-align: center">
		...
		<div class="layui-input-inline">
			<input type="text"  name="comtitle" id="comtitle" lay-verify="required" placeholder="请输入商品名称" autocomplete="off" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-inline">
		...
		<div class="layui-input-inline" >
			<select name="bname" id="bname" lay-filter="demo">
				<option value=""></option>
	...
	<div class="layui-form-item" style="text-align: center">
		...
		<div class="layui-input-inline">
			<input type="text"  name="address" id="address" lay-verify="required" placeholder="请输入收货地址" autocomplete="off" class="layui-input">
		</div>
	</div>
