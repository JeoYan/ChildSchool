	...
	<div  lay-filter="layuiadmin-form-useradmin" id="layuiadmin-form-useradmin" style="padding: 20px 0 0 0;">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" class="layui-input" id="wName" name="wName" value="${sessionScope.wName}" style=" border: none;"disabled="disabled">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" class="layui-input" name="nctitle" id="nctitle"placeholder="请输入标题" style="width: 300px">
