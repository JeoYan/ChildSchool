...
<script>
	...
	layui.use('table', function () {
		...
		table.render({
			elem: '#demo'
			, url: '${pageContext.request.contextPath}/mall/getCommPage.action' //数据接口
			, page: true //开启分页
			, limit: 5
			, done: function () {
			...
			, cols: [[ //表头
				...
				,{field: 'cpid', title: '商品id', align: 'center', width: 80,hide: true}
				, {field: 'comtitle', title: '名字', align: 'center', hide: true}
